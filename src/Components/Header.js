            ...
            <header class='flex shadow-sm bg-white font-[sans-serif] min-h-[70px]'>
                <div
                    ...
                    <div class="flex">
                        ...
                        <a href="javascript:void(0)" class="ml-8"><h1>Car rental</h1>
                        </a>
                    </div>

                    <div
                        class="bg-gray-100 p-2 flex border-2 border-black-200  max-md:order-1  focus-within:bg-transparent px-4  h-20 lg:w-2/6 max-md:w-full" style={{ borderRadius: '10px' }}>
                        ...
                        <input type='text' placeholder='Search.......' class="w-full outline-none bg-transparent text-[#333] text-2xl" />
                    </div>

                    <div class='flex items-center space-x-8 max-md:ml-auto text-2xl'>
                        <a href="/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" class="cursor-pointer fill-[#333] hover:fill-[#077bff]"
